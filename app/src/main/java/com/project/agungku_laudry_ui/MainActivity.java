package com.project.agungku_laudry_ui;
...
import com.project.agungku_laudry_ui.menu.home.HomeFragment;
import com.project.agungku_laudry_ui.menu.message.MessageFragment;
import com.project.agungku_laudry_ui.menu.notification.NotificationFragment;
import com.project.agungku_laudry_ui.menu.search.SearchFragment;
...
//        navigationView.setItemIconTintList(null); //disable tint on each icon to use color icon svg
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.menu_profile) {
            Uri uri = Uri.parse("https://github.com/Agungpriatin/laudry_app");
